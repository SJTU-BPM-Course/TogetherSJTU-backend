...
insert  into `circle`(`cirid`,`cirname`,`cirdesc`,`circreatorid`,`circreator`,`cirmembers`,`ciractivities`) values (0000000001,'肥宅艺术家','肥宅们的快乐基地',2,'冼健邦','[1,2,3]','[1,2]'),(0000000002,'一颗赛艇协会','一颗赛艇，是一种网络用语，为英文exciting的谐音，常用来形容令人兴奋和激动的事件或情形。',2,'冼健邦','[2]','[2]'),(0000000003,'快乐摸鱼人','摸鱼人的快乐源泉',3,'黄子昂','[1,2,3]','[5]'),(0000000014,'2020研究生','爬',2,'冼健邦','[2,3,4]','[1]');
...
insert  into `record_circle_activity`(`recid`,`cirid`,`actid`) values (1,1,1),(2,1,2),(3,2,2),(6,3,5),(7,14,1);
...
insert  into `record_user_activity`(`recid`,`recstatus`,`userid`,`actid`) values (0000000001,0000000001,2,1),(0000000004,0000000000,2,3),(0000000005,0000000000,2,2),(0000000008,0000000000,4,1),(0000000009,0000000000,4,4),(0000000010,0000000001,2,4),(0000000011,0000000001,3,1);
